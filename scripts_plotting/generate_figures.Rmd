...
s_nlsfit = 
  list('30C' =
         tibble(length=lengths, 
                pSup=psup_curve(length, beta = beta_fit, chi = chi_fit, mu = 0, nu = 0, baseline=0), 
                Temperature='30C.line'), 
       '42C' = 
         tibble(length=lengths,                       
                pSup=psup_curve(length, beta = beta_fit, chi = chi_fit, mu = mu_fit_42C, nu = nu_fit_42C, baseline=0), 
                Temperature='42C.line'),
       '46C' = 
         tibble(length=lengths,                       
                pSup=psup_curve(length, beta = beta_fit, chi = chi_fit, mu = mu_fit_46C, nu = nu_fit_46C, baseline=0), 
...
s_nlsfit.nomu = 
    list('30C' =
       ...
       '42C' = 
         tibble(length=lengths,                       
                pSup=psup_curve(length, beta = beta_fit, chi = chi_fit, mu = 0, nu = nuonly_fit_42C, baseline=0), 
                Temperature='42C.line'),
       '46C' = 
         tibble(length=lengths,                       
                pSup=psup_curve(length, beta = beta_fit, chi = chi_fit, mu = 0, nu = nuonly_fit_46C, baseline=0), 
                Temperature='46C.line') 
  )
