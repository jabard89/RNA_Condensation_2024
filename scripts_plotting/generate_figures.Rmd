...
#ggsave(file.path(github_dir, "figures/Figure1/Fig1_prot_vs_mRNA_condensation.pdf"), egg::set_panel_size(p_prot_vs_mRNA_condensation, width = unit(50, "mm"), height = unit(50, "mm")),
