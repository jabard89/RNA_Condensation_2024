...
p_psup_compare <- ggplot(data = df_psup_compare,
                           aes(x = pSup_qPCR, y = pSup_RNAseq, color = as.factor(Temperature), shape = ORF)) +
  geom_point(size = 5) +
  ...
  scale_shape_discrete(labels = c("clover" = "Clover",
                              "YBR072W" = "HSP26",
                              "YEL009C" = "GCN4",
                              "YFL031W" = "HAC1",
                              "YCR012W" = "PGK1",
                              "YER155C" = "BEM2")) +
  guides(color=guide_legend(title="Treatment (\u00b0C):"),
...
ggsave( file.path(github_dir,"figures/pSup_qpcr_rnaseq_comparison.pdf"), p_psup_compare, width =4.5, height = 4.5)
```